...
class IndonesianIPTVProvider : MainAPI() {
    ...
    private val indonesianChannels = listOf(
        ...
        ChannelData("iNews", "https://inews-cutv.rctiplus.id/inews-sdi.m3u8", "$alkhalifitvBase/inews.png", "Berita"),
        ...
        ChannelData("BeritaSatu", "https://beritasatu.secureswiftcontent.com/han/beritasatu/bsatu10008r/srtoutput/manifest.m3u8", "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/BeritaSatu_%28Flat%29.svg/960px-BeritaSatu_%28Flat%29.svg.png", "Berita"),
        ChannelData("Jakarta Globe News", "https://jktglobe.secureswiftcontent.com/han/jktglobe/jktglober/srtoutput/manifest.m3u8", "https://static.wikia.nocookie.net/logopedia/images/e/ea/Jakarta_globe_news_channel_id.png", "Berita"),
        ...
        ChannelData("My Kidz", "http://op-group1-swiftservesd-1.dens.tv/h/h191/index.m3u8", "$alkhalifitvBase/mykidz.png", "Anak"),
        ...
        ChannelData("Surau TV", "https://surautv.siar.us/live/surautv.m3u8", "https://static.wikia.nocookie.net/logopedia/images/7/7e/Surau_TV.png", "Religi"),
        ...
        ChannelData("TV MUI", "https://mui.siar.us/mui/live/playlist.m3u8", "$alkhalifitvBase/muslimtv.png", "Religi"),
        ...
        ChannelData("Elshinta TV", "https://ams.juraganstreaming.com:5443/LiveApp/streams/elshintatv.m3u8", "https://upload.wikimedia.org/wikipedia/commons/f/f4/ElshintaTV2019.png", "Daerah"),
        ...
        ChannelData("Semarang TV", "http://116.254.112.74/hls/cakralive.m3u8", "$iconBase/iptv.png", "Daerah"),
        ...
        ChannelData("Nasional TV", "https://tv.nasionaltv.com/ntvlive/index.m3u8", "$iconBase/iptv.png", "Daerah"),
        ChannelData("Madu TV", "https://re1.siar.us/madutv/hd720/playlist.m3u8", "$iconBase/iptv.png", "Daerah"),
        ChannelData("Bandung TV", "http://202.150.153.254:65500/bandungtvWEBSITE.m3u8", "$alkhalifitvBase/bandungtv.png", "Daerah"),
        ...
        ChannelData("Banten TV", "https://5bf7b725107e5.streamlock.net/bantentv/bantentv/playlist.m3u8", "$iconBase/iptv.png", "Daerah"),
        ChannelData("Kilisuci TV", "https://5bf7b725107e5.streamlock.net:443/kstv/kstv/playlist.m3u8", "$iconBase/iptv.png", "Daerah"),
        ChannelData("BMS TV", "https://5bf7b725107e5.streamlock.net/bmstv/bmstv/playlist.m3u8", "$iconBase/iptv.png", "Daerah"),
