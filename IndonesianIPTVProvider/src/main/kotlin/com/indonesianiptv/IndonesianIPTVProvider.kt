...
class IndonesianIPTVProvider : MainAPI() {
    ...
    private val indonesianChannels = listOf(
        ...
        ChannelData("MOJI", "http://op-group1-swiftservehd-1.dens.tv/h/h207/02.m3u8", "$iconBase/net.png", "Nasional"),
        ...
        ChannelData("iNews", "https://inews-cutv.rctiplus.id/inews-sdi.m3u8", "https://alkhalifitv.github.io/TV/big/inews.png", "Berita"),
        ...
        ChannelData("BN Channel", "http://op-group1-swiftservehd-1.dens.tv/h/h39/01.m3u8", "$iconBase/mnctv.png", "Berita"),
        ...
        ChannelData("Motorvision TV", "http://op-group1-swiftservehd-1.dens.tv/h/h09/01.m3u8", "https://alkhalifitv.github.io/TV/big/motorvision.png", "Olahraga"),
        ...
        ChannelData("MQTV", "https://wahyu1ptv.pages.dev/MQTV-HD.m3u8", "$iconBase/rodjatv.png", "Religi"),
        ChannelData("WesalTV", "https://wahyu1ptv.pages.dev/WesalTV-HD.m3u8", "$iconBase/rodjatv.png", "Religi"),
        ChannelData("AshillTV", "https://wahyu1ptv.pages.dev/AshiilTV-HD.m3u8", "$iconBase/rodjatv.png", "Religi"),
        ChannelData("TV MUI", "https://mui.siar.us/mui/live/playlist.m3u8", "$iconBase/rodjatv.png", "Religi"),
        ChannelData("JTV", "http://122.248.43.242:1935/JTVSURABAYA/_definst_/myStream/playlist.m3u8", "$iconBase/jtv.png", "Daerah"),
        ChannelData("JAKTV", "http://op-group1-swiftservesd-1.dens.tv/s/s123/S4/mnf.m3u8", "https://alkhalifitv.github.io/TV/big/jaktv.png", "Daerah"),
        ChannelData("Jowo Channel", "http://khano.nng.cloudns.us/live/m3u8/id/1de333734b1b7e0.m3u8", "https://alkhalifitv.github.io/TV/big/jowo.png", "Daerah"),
        ...
        ChannelData("Nasional TV", "https://tv.nasionaltv.com/ntvlive/index.m3u8", "$iconBase/jtv.png", "Daerah"),
        ChannelData("Madu TV", "https://re1.siar.us/madutv/hd720/playlist.m3u8", "$iconBase/jtv.png", "Daerah"),
        ChannelData("Bandung TV", "http://202.150.153.254:65500/bandungtvWEBSITE.m3u8", "$iconBase/jtv.png", "Daerah"),
        ChannelData("Jogja TV", "https://stream.jogjatv.co.id/jtvlive/stream/index.m3u8", "$iconBase/jtv.png", "Daerah"),
        ChannelData("Banjar TV", "https://banjartv.siar.us/banjartv/live/playlist.m3u8", "$iconBase/jtv.png", "Daerah"),
        ChannelData("RCTV", "https://v10.siar.us/rctv/live/playlist.m3u8", "$iconBase/jtv.png", "Daerah"),
        ChannelData("Banten TV", "https://5bf7b725107e5.streamlock.net/bantentv/bantentv/playlist.m3u8", "$iconBase/jtv.png", "Daerah"),
        ChannelData("Kilisuci TV", "https://5bf7b725107e5.streamlock.net:443/kstv/kstv/playlist.m3u8", "$iconBase/jtv.png", "Daerah"),
        ChannelData("BMS TV", "https://5bf7b725107e5.streamlock.net/bmstv/bmstv/playlist.m3u8", "$iconBase/jtv.png", "Daerah"),
        ChannelData("TATV", "https://tatv.siar.us/tatv/live.sdp/playlist.m3u8", "$iconBase/jtv.png", "Daerah"),
        ChannelData("Dhamma TV", "https://b.webcache.maxindo.net.id/dhamma/dhamma.m3u8", "$iconBase/jtv.png", "Daerah"),
    )
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        val episodes = indonesianChannels.mapIndexed { i, ch ->
